...
void main(){
    ...
    irradiance_IBL=textureCube(u_irradianceMap,N,roughness*MAX_REFLECTION_LOD).rgb;
    ...
    vec2 uvLUT=vec2(max(dot(N,V),.0001),roughness).rg;
    ...
    // color=vec3(prefilteredColor*kS_IBL);
